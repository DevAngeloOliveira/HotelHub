          ...
          <AnimatePresence>
            {filtered.length === 0 ? (
              <div className="text-center py-20">
                ...
                <Link href="/search" className="mt-4 inline-flex items-center gap-2 text-[#8b5cf6] text-sm hover:text-[#a78bfa]">
                  Explorar hotéis
                              ...
                              <div className="border-t border-[#1a1a1a] mt-4 pt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                  ...
                                  <div className="flex flex-col gap-2">
                                    ...
                                    <Link href={`/hotels/h1`} className="flex items-center gap-2 text-xs text-[#a1a1aa] hover:text-[#8b5cf6] transition-colors">
