...
import { Star, Check, ArrowRight, Clock, Plane } from "lucide-react";
    ...
    >
      <div className={`relative overflow-hidden ${featured ? "lg:w-96 h-64 lg:h-auto" : "h-52"}`}>
        ...
        <div className="absolute top-3 left-3 flex items-center gap-2">
          <span
            className="px-2.5 py-1.5 rounded-xl bg-gradient-to-r from-[#34d399] to-[#10b981] text-black text-xs"
        ...
        <div>
          <div className="flex items-start justify-between mb-2">
            ...
            <div className="flex items-center gap-1 bg-[#8b5cf6]/10 px-2 py-1 rounded-lg">
              ...
              <span className="text-[#a78bfa] text-xs" style={{ fontWeight: 600 }}>
                {pkg.rating}
              </span>
            </div>
          </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                {pkg.departures.map((dep) => (
                  <span
                    key={dep}
                    className="text-xs text-white bg-[#111111] border border-[#333333] px-2 py-1 rounded-lg"
                  >
                    {dep}
                  </span>
                ))}
