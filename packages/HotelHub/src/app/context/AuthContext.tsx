...
export interface TravelProfile {
  styles: string[];       // adventure, luxury, cultural, beach, etc.
  regions: string[];      // europe, asia, americas, etc.
  budget: string;         // economic, moderate, premium, ultra
  frequency: string;      // rarely, sometimes, often, always
  companions: string[];   // solo, couple, family, friends
  interests: string[];    // gastronomy, photography, sports, etc.
}
