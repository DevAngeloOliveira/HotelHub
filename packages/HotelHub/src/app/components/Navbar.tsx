...
import {
  Globe, Bell, Menu, X, ChevronDown,
  Compass, Building2, Package, Calendar,
  LogIn, Sparkles, LogOut, User, Star, Settings
} from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center gap-2.5 group shrink-0">
              ...
              <span className="text-white hidden sm:block" style={{ fontSize: "1.1rem", fontWeight: 700 }}>
                ...
                <>
                  ...
                  <div className="relative" ref={userMenuRef}>
                    ...
                    >
                      ...
                      <span className="text-[#d1d5db] text-sm max-w-[90px] truncate">{user.name.split(" ")[0]}</span>
                      <ChevronDown className={`w-3.5 h-3.5 text-[#555] transition-transform ${userMenuOpen ? "rotate-180" : ""}`} />
                    </button>
                        ...
                        >
                          ...
                          <div className="px-4 py-4 bg-gradient-to-br from-[#8b5cf6]/10 to-transparent">
                            ...
                            <div className="flex items-center gap-1.5 bg-[#8b5cf6]/10 border border-[#8b5cf6]/20 rounded-lg px-2.5 py-1.5">
                              ...
                              <span className="text-[#a78bfa] text-xs font-semibold">{user.points.toLocaleString()} pontos</span>
                              <Badge variant="default" className="ml-auto text-[10px] px-1.5 py-0">Gold</Badge>
                            </div>
                            ...
                            {user.travelProfile && user.travelProfile.styles.length > 0 && (
                              <div className="flex flex-wrap gap-1 mt-2">
                                {user.travelProfile.styles.slice(0, 3).map(s => (
                                  <span key={s} className="text-[10px] text-[#555] bg-[#111] border border-[#1a1a1a] px-1.5 py-0.5 rounded-full capitalize">
                                    {s}
                                  </span>
                                ))}
                              </div>
                          ...
                          <div className="py-1.5">
                            ...
                            >
                              ...
                              Minhas Reservas
                              <span className="ml-auto text-xs text-[#34d399] bg-[#34d399]/10 px-1.5 py-0.5 rounded-md">{user.totalTrips}</span>
                            </Link>
                            <button
                              className="w-full flex items-center gap-3 px-4 py-2.5 text-[#a1a1aa] hover:text-white hover:bg-white/5 transition-all text-sm text-left"
                            >
